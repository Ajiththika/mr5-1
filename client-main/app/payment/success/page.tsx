			...
			<div className="min-h-screen flex items-center justify-center bg-background relative overflow-hidden">
				...
				>
					...
					<div className="text-center space-y-2">
						<h2 className="text-2xl font-bold text-foreground uppercase tracking-widest italic">Syncing Access</h2>
	...
	if (error) {
		return (
			<div className="min-h-screen flex items-center justify-center bg-background p-4">
				...
				>
					<Card className="bg-card/90 border-border backdrop-blur-xl overflow-hidden relative">
						...
						<CardContent className="pt-10 pb-8 px-8 flex flex-col items-center text-center">
							...
							<h2 className="text-2xl font-bold text-foreground mb-2 uppercase italic tracking-tight">Access Denied</h2>
	...
	return (
		<div className="min-h-screen bg-background flex flex-col relative overflow-hidden">
			...
			<main className="flex-1 container mx-auto px-4 flex items-center justify-center relative z-10 py-20">
				...
				>
					<Card className="bg-card/90 border border-border backdrop-blur-3xl overflow-hidden shadow-[0_0_50px_rgba(120,110,255,0.15)]">
						...
						<CardContent className="pt-16 pb-12 px-10 text-center">
							...
							<h1 className="text-4xl md:text-5xl font-black text-foreground italic tracking-tighter uppercase mb-2">
							...
							<div className="p-6 rounded-2xl bg-white/5 border border-white/5 mb-10 text-left relative overflow-hidden group">
								...
								<h2 className="text-2xl font-bold text-foreground mb-4 line-clamp-1">{enrollment.course?.title}</h2>
							...
							<div className="flex flex-col md:flex-row gap-4 justify-center">
								<Button size="lg" className="h-16 px-10 bg-primary hover:bg-primary/90 text-primary-foreground font-black uppercase italic tracking-widest shadow-[0_0_30px_rgba(120,110,255,0.3)] border border-border group" asChild>
								...
								<Button variant="outline" size="lg" className="h-16 px-8 border-border bg-muted/50 hover:bg-muted text-foreground font-bold uppercase tracking-widest" asChild>
					...
					<p className="text-center mt-8 text-muted-foreground text-[10px] uppercase font-mono tracking-[0.3em]">
