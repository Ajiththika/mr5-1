...
const userSchema = new mongoose.Schema(
	{
		...
		purchasedTeacherAvatars: {
			type: [String],
			default: ["teacher_default"],
		},
		ownedClassroomItems: { type: [String], default: [] },
		ownedAudioPacks: { type: [String], default: [] },
		...
		equippedActivityPack: { type: String, default: "" },
		equippedClassroomPack: { type: String, default: "" },
		welcomeMessage: {
			type: String,
			default: "Welcome to MR5 School.",
			maxlength: 80,
			trim: true,
		},
	},
